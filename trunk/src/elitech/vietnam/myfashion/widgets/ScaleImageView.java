...
public class ScaleImageView extends ImageView {
	...
	public void setImageBitmap(Bitmap bm) {
		...
		if(isAnimation){
			Animation anim_in  = AnimationUtils.loadAnimation(getContext(), android.R.anim.fade_in); 
	...
	public ScaleImageViewEvent event = null;

	
	public void setOnDetachedFromWindow(ScaleImageViewEvent mEvent) {
		this.event = mEvent;
	}
	
	public interface ScaleImageViewEvent {
