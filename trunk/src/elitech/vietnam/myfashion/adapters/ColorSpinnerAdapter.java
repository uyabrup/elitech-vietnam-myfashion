...
public class ColorSpinnerAdapter extends ArrayAdapter<Color> {
	...
	public ColorSpinnerAdapter(Context context, List<Color> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		((TextView) convertView).setText(getItem(position).NameVN);
		return convertView;
	}
	...
	public View getDropDownView(int position, View convertView, ViewGroup parent) {
		...
		view.setText(getItem(position).NameVN);
		return view;
	}
}
