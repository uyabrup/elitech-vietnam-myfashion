...
import elitech.vietnam.myfashion.adapters.CommentAdapter.ViewHolder;
 ...
 *
 */
public class CommentDialogAdapter extends ArrayAdapter<Comment> {

	public CommentDialogAdapter(Context context, List<Comment> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.mTxtContent.setText(item.Content);
